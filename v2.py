...
def feature_expansion(X, Y):
    ...
    custom_nn(X_train, Y_train, X_dev, Y_dev, 100)
    custom_nn(poly.fit_transform(X_train), Y_train, poly.transform(X_dev), Y_dev, 100)
    custom_nn(X_train, Y_train, X_dev, Y_dev, 1000)
    custom_nn(poly.fit_transform(X_train), Y_train, poly.transform(X_dev), Y_dev, 1000)
